...
class MDPAgent(Agent):
    ...
    def __init__(self):
        ...
        self.__THREAT_DECAY_RATE = 50.0  # tasso di decadimento della minaccia
        self.__DISCOUNT_FACTOR = 0.7
        self.__CONVERGENCE_TOLERANCE = 0.1  # La nostra theta
    ...
    def __mapping_operation(self, state, debug_mode):
        ...
        if self.__corners == None:
            ...
            # restringo la mappa in modo da non considerare i muri esterni
            # andando a cambiare i valori dei corners
            # get_inner_corners
        ...
        # Determino le coordinate di ogni cella di tipo pavimento
        ...
        # __neighbors sarebbe la lista di adiacenza (attenzione considera come vicini anche i muri)
